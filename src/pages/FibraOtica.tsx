        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="text-4xl font-bold mb-6">299 Kz<span className="text-lg text-gray-600">/mês</span></div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 transform scale-105 border-2 border-blue-600">
              ...
              <div className="text-4xl font-bold mb-6">499 Kz<span className="text-lg text-gray-600">/mês</span></div>
              <ul className="space-y-4 mb-8">
                <li className="flex items-center">
                  <span className="w-5 h-5 bg-blue-100 rounded-full flex items-center justify-center mr-3">
                    <span className="text-blue-600">✓</span>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="text-4xl font-bold mb-6">899 Kz<span className="text-lg text-gray-600">/mês</span></div>
              <ul className="space-y-4 mb-8">
                <li className="flex items-center">
                  <span className="w-5 h-5 bg-blue-100 rounded-full flex items-center justify-center mr-3">
                    <span className="text-blue-600">✓</span>
